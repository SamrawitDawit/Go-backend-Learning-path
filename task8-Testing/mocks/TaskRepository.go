...
func (_m *TaskRepository) AddTask(c context.Context, task *domain.Task) error {
...
func (_m *TaskRepository) GetTask(c context.Context, taskID primitive.ObjectID) (domain.Task, error) {
...
func (_m *TaskRepository) RemoveTask(c context.Context, taskID primitive.ObjectID) error {
	ret := _m.Called(c, taskID)
...
func (_m *TaskRepository) UpdateTask(c context.Context, taskID primitive.ObjectID, updatedTask *domain.Task) error {
