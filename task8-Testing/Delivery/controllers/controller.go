...
func (controller *Controller) Register(c *gin.Context) {
	...
	if newUser.Username == "" || newUser.Password == "" {
		c.JSON(http.StatusBadRequest, gin.H{"Error": "Username and Password are required fields"})
		c.Abort()
		return
	}
...
func (controller *Controller) Login(c *gin.Context) {
	...
	if unauthenticatedUser.Username == "" || unauthenticatedUser.Password == "" {
		c.JSON(http.StatusBadRequest, gin.H{"Error": "Username and Password are required fields"})
		c.Abort()
		return
	}
...
func (controller *Controller) GetTasks(c *gin.Context) {
	...
	if err != nil {
		c.JSON(500, gin.H{"error": "something went wrong while retrieving the tasks"})
	}
